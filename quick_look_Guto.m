...
% Guto (Dez/2024): 
% I made small changes to include the date & time in the output structure.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Guto to left 'd' in the workspace
% assignin('base','d', d)
...
prf_minute = d.Minute;
prf_second = d.Second;
%prf_date = strcat(num2str(prf_year), num2str(prf_month), num2str(prf_day));
prf_date1 = strcat(num2str(prf_year), '-', sprintf('%02d', prf_month), '-', sprintf('%02d', prf_day));
prf_time = strcat(sprintf('%02d',prf_hour), ':', sprintf('%02d', prf_minute), ':', sprintf('%02d', prf_second));
prf_date = [prf_date1, ' ', prf_time];
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Guto: inserting the profile date in the output
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
diss.file_start_datetime = prf_date;
